function sidebar_toggle_transcen() {
  var root = document.documentElement;
  var buttonText = document.getElementById('FSTranscen');
  if (~root.className.indexOf(' selector')) {
    root.className = root.className.replace(' selector', '');
    $(document.getElementById("ninja-slider10")).css("-webkit-transform","scale(1,1)");
    $(document.getElementById("ninja-slider10")).css("background-color","rgba(0,0,0,0)");
    $(document.getElementsByTagName("body")).css("overflow","auto");
    $(document.getElementById("ninja-slider10")).toggleClass("emphasized");
    buttonText.value = "EXPAND";
  } else {
    root.className += ' selector';
    $(document.getElementById("ninja-slider10")).css("-webkit-transform","scale(1.2,1.2)");
    $(document.getElementById("ninja-slider10")).css("background-color","rgba(0,0,0,0.7");
    $(document.getElementsByTagName("body")).css("overflow","hidden");
    $(document.getElementById("ninja-slider10")).toggleClass("emphasized");
    buttonText.value = "CLOSE";

    // $(document).mouseup(function (e){
    //   // var container = $("#ninja-slider8");
...
function sidebar_toggle_fluid() {
  ...
  if (~root.className.indexOf(' selector')) {
    root.className = root.className.replace(' selector', '');
    $(document.getElementById("ninja-slider9")).css("-webkit-transform","scale(1,1)");
    $(document.getElementById("ninja-slider9")).css("background-color","rgba(0,0,0,0)");
    $(document.getElementsByTagName("body")).css("overflow","auto");
    $(document.getElementById("ninja-slider9")).toggleClass("emphasized");
    buttonText.value = "EXPAND";
  } else {
    root.className += ' selector';
    $(document.getElementById("ninja-slider9")).css("-webkit-transform","scale(1.2,1.2)");
    $(document.getElementById("ninja-slider9")).css("background-color","rgba(0,0,0,0.7");
    $(document.getElementsByTagName("body")).css("overflow","hidden");
    $(document.getElementById("ninja-slider9")).toggleClass("emphasized");
    buttonText.value = "CLOSE";
